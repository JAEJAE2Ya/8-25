...
const profileDto = (profile: { dailyCalories: number; carbsTarget: number; proteinTarget: number; fatTarget: number; allergies: string | null; foodPreferences: string | null }) => ({
...
export function registerProfileRoutes(app: FastifyInstance, db: PrismaClient, config: AppConfig) {
