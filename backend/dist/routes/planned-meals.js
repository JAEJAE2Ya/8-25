...
async function plannedInput(db, userId, value) {
...
export function registerPlannedMealRoutes(app, db, config) {
    ...
    app.post("/api/planned-meals/:id/consume", async (request, reply) => {
        const user = await requireAuth(request, reply, db, config);
        if (!user)
            return;
...
//# sourceMappingURL=planned-meals.js.map